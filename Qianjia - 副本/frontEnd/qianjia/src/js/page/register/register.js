...
class Register extends Component{
    ...
    //邀请码失去焦点
    inviteBlur(){
        let invite = this.value;
        let regInvite = /^1[3|4|5|7|8][0-9]{9}$/; //验证规则  验证邀请码13、 14、 15、 17、 18开头
        let IsInvite=regInvite.test(invite);
        if(invite != ''){
            if(!IsInvite){
                componentStore.update(_that,{
                    inviteError:true
                })
                Toast.info('输入的邀请码不合法',1)
            }
        }
    }
    //邀请码得到焦点
    ...
    ragisterClick(){
        ...
        //邀请码
        let invite = _that.state.inviteValue;
        let regInvite = /^1[3|4|5|7|8][0-9]{9}$/; //验证规则  验证邀请码13、 14、 15、 17、 18开头
        let IsInvite=regInvite.test(invite);
        if(invite != ''){
            if(!IsInvite){
        ...
        return (
             <div>
                ...
                <div className="ragister">
                    <div className="ragister_title"></div>
                    <div className="ragister_list">
                        <ul>
                            <li>
                                <div className="_left">
                                    <div className="_img">
                    ...
                    <div className="invite">
                        <ul>
                            <li>
                                <div className="_left">
                                    <div className="_img">
                                        <img src={require('../../../image/icon/register_invite.png')} alt=""/>
                                    </div>
                                </div>
                                <div className="_right _rightLast">
                                    <div className="_right_B">
                                        <InputItem
                                            ...
                                            onBlur={this.inviteBlur}
                                            onFocus={this.inviteFocus}
                                            value={this.state.inviteValue}
                                            onChange={(value)=>{
                                                this.state.inviteValue = value;
                                                componentStore.update(this,this.state)
                                            }}
                                        >
                                        </InputItem>
                    ...
                    <div className="ragister_btm">
                        <div className="ragister_btn">
                            <Button content="注册" click={this.ragisterClick} $id="ragister" width="90%" lineH={0.85+'rem'} radius="8px" height={0.85+'rem'}></Button>
                        </div>
                    </div>
                </div>
...
const Global_register = createForm()(Register);
export default Global_register;
