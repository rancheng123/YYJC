...
import CountTime from '../../widget/countTime/countTime';
            ...
            <div className="indexPage">
                ...
                <div style={{border:'1px solid #000'}}>
                    <button onClick={
                        ...
                        this.state.isShow=='block' ? '收起' : '展开'
                    }</button>
                    {this.props.children}
                    <ul style={{display:this.state.isShow,lineHeight: '30px'}}>
                        <li>
                            <Link to="/detail/first">first</Link>
                        </li>
                    </ul>
                </div>
                <br />
                ...
                <div onTouchEnd={() => {
                    ...
                    Utils.switchRoute('/findback_password?scrollTop='+currentPos);
