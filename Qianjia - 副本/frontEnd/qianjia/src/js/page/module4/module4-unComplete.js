    ...
    getData(opts){
        ...
        if(opts.scrollDeriction == 'down'){
            ...
            setTimeout(function(){
                ...
                for(var i=0;i<tiaoshu;i++){
                    that.state.data.unshift({
                        name: 'up'+(that.state.count*10+i),
                        age: 'up'+(that.state.count*10+i)
                    })
                };
                that.state.loading = false;
                componentStore.update(that,that.state,function(){
